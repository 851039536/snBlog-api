...
namespace Snblog.Service
{
    public class VideoService : IVideoService
    {
        ...
        public async Task<List<VideoDto>> GetFyAsync(int identity, string type, int pageIndex, int pageSize, string ordering, bool isDesc, bool cache)
        {
            _logger.LogInformation($"{VIDEO}{分页查询}{identity}{pageIndex}{pageSize}{ordering}{isDesc}{cache}");
            rDto.entityList = _cacheutil.CacheString($"{VIDEO}{分页查询}{identity}{pageIndex}{pageSize}{ordering}{isDesc}{cache}", rDto.entityList, cache);
            if (rDto.entityList == null)
            {
                ...
                _cacheutil.CacheString($"{VIDEO}{分页查询}{identity}{pageIndex}{pageSize}{ordering}{isDesc}{cache}", rDto.entityList, cache);
            }
            return rDto.entityList;
        }
